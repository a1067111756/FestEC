...
public class MorphingButton extends Button {
    ...
    public MorphingButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MorphingButton);
        mColor = array.getColor(R.styleable.MorphingButton_backgroud_color, getResources().getColor(R.color.mb_blue));
        mStrokeColor = array.getColor(R.styleable.MorphingButton_stroke_color, getResources().getColor(R.color.mb_blue));
        mCornerRadius = array.getDimensionPixelSize(R.styleable.MorphingButton_corner_radius, (int) getResources().getDimension(R.dimen.mb_corner_radius_2));
        initView();
    }
    ...
    private void initView() {
        ...
        */
        ...
        mDrawableNormal = createDrawable(mColor, mCornerRadius, 0);
        mDrawablePressed = createDrawable(mColor, mCornerRadius, 0);
